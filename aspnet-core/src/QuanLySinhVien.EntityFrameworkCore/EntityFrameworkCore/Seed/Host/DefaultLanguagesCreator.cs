...
namespace QuanLySinhVien.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = QuanLySinhVienConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(QuanLySinhVienDbContext context)
        {
            _context = context;
        }
