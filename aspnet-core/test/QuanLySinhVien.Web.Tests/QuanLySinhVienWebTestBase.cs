...
using QuanLySinhVien.Models.TokenAuth;
...
{
    public abstract class QuanLySinhVienWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static QuanLySinhVienWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(QuanLySinhVienWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<QuanLySinhVienDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<QuanLySinhVienDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<QuanLySinhVienDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<QuanLySinhVienDbContext, Task<T>> func)
        {
            T result;
